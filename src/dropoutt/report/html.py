...
<section>
  ...
  <div class="card" style="margin-bottom:var(--s-12)">
    ...
    within it are different subregions. See your reach below.</p>
    ...
    <table class="agrid">
      ...
      {% for a in s.atlas.grid %}
        <tr{{ ' class="empty"'|safe if not a.records }}>
          ...
          <td class="r reach">{% if a.cells %}{% if a.unreached == 0 %}<span class="reach-ok" aria-hidden="true">✓ </span>{% else %}<span class="reach-miss" aria-hidden="true">✕ </span>{% endif %}{% endif %}{{ a.cells|length - a.unreached }}/{{ a.cells|length }}</td>
