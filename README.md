...
[docs/portability.md](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/portability.md) for offline / HPC use.
...
**New here?** [docs/getting-started.md](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/getting-started.md).
...
[docs/atlas.md](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/atlas.md).
...
in `dropoutt.toml`. Full narrative: [docs/checks.md](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/checks.md). Live list:
`dropoutt checks`.
...
- [Getting started](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/getting-started.md)
- [CLI reference](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/cli.md)
- [Check catalog](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/checks.md)
- [Fingerprint](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/fingerprint.md)
- [Atlas](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/atlas.md)
- [Configuration](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/configuration.md)
- [Portability / offline](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/portability.md)
- [Limitations](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/limitations.md)
- [Design rules](https://github.com/ckproduces/dropoutt-cli/blob/v1.4.1/docs/design.md)
